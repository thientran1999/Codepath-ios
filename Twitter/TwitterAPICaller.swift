...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "LdKJGpGFhUR17cHM818HxQ44s", consumerSecret: "wpBnzVtPPVJySmRa7ssWGt9LNW6fba0tpMprarAfrns0ZtnjXD")
    var loginSuccess: (() -> ())?
